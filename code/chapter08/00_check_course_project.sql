    ...
    IF v_student_count <> 3
       ...
       OR v_amount_1005 IS DISTINCT FROM 120000::numeric THEN
        RAISE EXCEPTION
            ...
            v_total_recorded_amount, v_avg_recorded_amount,
            v_requested_count, v_learning_count, v_completed_count, v_cancelled_count,
            v_active_count, v_active_recorded_amount,
            v_non_cancelled_count, v_non_cancelled_recorded_amount,
            v_orphan_student_count, v_orphan_course_count, v_orphan_instructor_count,
            v_active_duplicate_count,
            v_status_1001, v_amount_1001,
            v_status_1004, v_amount_1004,
            v_status_1005, v_amount_1005;
    END IF;
